...
<body>
    ...
    <section id="banner">
        <img src="Uploadimage/b2.webp" alt="">
        <div class="info">
            <h2>Welcome to 2wheeler</h2>
            <p>We Provide Orginal and Genuine Parts</p>
        </div>
    </section>
    <section id="content">
        <div class="wrapper">
            <h3>All Kinds Bikes Parts</h3>
            <div class="boxes">
                <div class="box">
                    <img src="Uploadimage/b3.jpg" alt="" srcset="">
                    <h4>
                        <a href="parts.php"> Bike Parts</a>
                    </h4>
            </div>
        </div>
    </section> 
